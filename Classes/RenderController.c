...
void aglBegin(GLenum prim) {
    ...
    vertexCount = 0;
    glVertexPointer(3, GL_FLOAT, sizeof(vertex_t), vertices[0].xyz);
    glTexCoordPointer(2, GL_FLOAT, sizeof(vertex_t), vertices[0].st);
    glColorPointer(4, GL_FLOAT, sizeof(vertex_t), vertices[0].rgba);
